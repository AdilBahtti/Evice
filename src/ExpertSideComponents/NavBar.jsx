...
import Card from './NotificationComponent/Card';
const Navbar=()=>{
  ...
  <div className={style.mobileBar}>
    <img className={style.brand} src={logo} alt="Evice" onClick={()=>{ close(); navigate("/DashBoard") }} />
    <button
  ...
  <NavLink to="/DashBoard" end onClick={close} className={({ isActive }) => (isActive ? style.active : '')}>
    DashBoard
  </NavLink>

  <NavLink to="/DashBoard/Booking" onClick={close} className={({ isActive }) => (isActive ? style.active : '')}>
    Bookings
  </NavLink>
  <NavLink to="/DashBoard/Wallet" onClick={close} className={({ isActive }) => (isActive ? style.active : '')}>
    Wallet
  </NavLink>
  <NavLink to="/DashBoard/Call" onClick={close} className={({ isActive }) => (isActive ? style.active : '')}>
    Calls
  </NavLink>
  <NavLink to="/DashBoard/Contact-Us" onClick={close} className={({ isActive }) => (isActive ? style.active : '')}>
    Contact Us
  </NavLink>
  <NavLink to="/DashBoard/FAQs" onClick={close} className={({ isActive }) => (isActive ? style.active : '')}>
    FAQs
  </NavLink>
</div>
        ...
        <div className={`${style.right} ${open ? style.open : ''}`}>
               ...
               <div className={style.con}>
                <img onClick={()=>{ close(); navigate("/Client")}} src={img} alt="" />
